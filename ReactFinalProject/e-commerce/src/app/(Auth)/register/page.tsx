...
export default function Register() {  
  ...
  //[shad cn form] is integrated with react hook form components so it install React hook form and zod  
  //  when we istall it   
  // register => to link normal input jsx element & control => to link component with useForm   
...
const router = useRouter();
  ...
  async function myHandleSubmit(data:RegisterFormType){ 
    ...
    //handleRegister We made it return true or error msg if the return true we will display message by shad cn sooner  
